...
const services = [
  {
    title: "Step 1 — Create a League",
    text: "Give your league a name, set your scoring rules, and choose your event.",
  ...
  {
    title: "Step 2 — Invite Friends",
    text: "Share your unique link with anyone you want to compete with.",
  ...
  {
    title: "Step 3 — Make Predictions",
    text: "Players submit their guesses before the deadline.",
  ...
  {
    title: "Step 4 — Follow Scores",
    text: "Watch the leaderboard update as the event unfolds.",
...
const solutions = [
  {
    title: "Create Prediction Leagues in Seconds",
    text:
      "Set up a league for any event — Oscars, sports championships, elections, bitcoin price forecasts — no tech skills required. Customize rules and invite your friends instantly.",
    img: visibilityDilemma,
  },
  {
    title: "Score & Compete in Real Time",
    text:
      "Track points as predictions come in, compare leaderboards, and see who’s top dog across your group. It’s social competition made easy.",
    img: engagementGap,
  },
  {
    title: "Engage Your Community",
    text:
      "Perfect for friends, coworkers, or entire fan communities. Share leagues publicly or keep them private — you control who joins.",
